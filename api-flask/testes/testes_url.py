...
#         r = requests.post('http://localhost:8000/alunos',json={'nome':'fernando','id':1})
#         r = requests.post('http://localhost:8000/alunos',json={'nome':'roberto','id':2})
...
#         r = requests.post('http://localhost:8000/alunos',json={'nome':'mario','id':20})

#         #consulta a url /alunos/20, pra ver se o aluno está lá
#         resposta = requests.get('http://localhost:8000/alunos/20')
...
#         r = requests.post('http://localhost:8000/alunos',json={'nome':'cicero','id':29})
#         #peguei a lista
#         r_lista = requests.get('http://localhost:8000/alunos')
...
#         r_lista_depois = requests.get('http://localhost:8000/alunos')
